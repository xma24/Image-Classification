...
```bash
$ pip install git+https://github.com/xma24/image_classification.git
```
...
### Image classification by finetune existing pretrained models
- Replace `train_images_txtfile`, `train_labels_txtfile`, `val_images_txtfile`, `val_labels_txtfile`.
- The model can automatically mapping the classification index with the class names.
